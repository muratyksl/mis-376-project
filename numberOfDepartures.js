...
export const drawNumberofDepartures = (countries, start = 0, end = 122) => {
  const departures = countries.filter(
    (country) => country["Series Code"] === "IS.AIR.DPRT"
  );
  ...
  return new Chart(document.getElementById("line-chart-departures"), {
    type: "line",
    data: {
      labels: [

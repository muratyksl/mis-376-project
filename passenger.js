...
export const drawPassenger = (countries, start = 0, end = 122) => {
  const departures = countries.filter(
    (country) => country["Series Code"] === "IS.AIR.PSGR"
  );
  ...
  return new Chart(document.getElementById("line-chart-passenger"), {
    type: "line",
    data: {
      labels: [
